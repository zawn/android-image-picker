 ...
 * the constructors that also takes a field id. That field id should
 ...
 * each object in the array. You can add lists or arrays of custom
 * objects. Override the toString() method of your objects to determine what
 * text will be displayed for the item in the list.
 * 
...
abstract public class ArrayAdapter<T> extends BaseAdapter implements Filterable {
    ...
    public ArrayAdapter(Context context, int resource, T[] objects) {
        init(context, resource, new ArrayList<T>(Arrays.asList(objects)));
    }
    ...
    private View createViewFromResource(int position, View convertView,
        ...
        View view2 = attachDataToView(position, getItem(position), view);
        if (view2 == null) {
            throw new NullPointerException("attachDataToView 返回的View对象不可为空");
        }
        return view2;
    }
